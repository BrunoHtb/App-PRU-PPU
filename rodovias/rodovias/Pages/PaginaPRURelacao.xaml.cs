...
namespace rodovias.Pages
{
    ...
    public partial class PaginaPRURelacao : ContentPage
    {
        ...
        public PaginaPRURelacao()
        {
            InitializeComponent();
            BtnCarregarPlanejados_Clicked(senderr, ee);
            NavigationPage.SetTitleIcon(this, "@drawable/PRU_branco1.png");
        }
        ...
        private async void BtnCarregarPlanejados_Clicked(object sender, EventArgs e)
        {
            ...
            string _caminhoDoArquivoTxt = root.Path + "/files/Pictures/PRU";
            ...
            else
            {
                ...
                for (int i = 0; i < totalDeArquivosTxtNoDiretorio.Length; i++)
                {
                    ...
                    {
                        listReceberDadosExterno.ItemsSource = SelecionarTodos.ObterRegistro(Path.GetFullPath(totalDeArquivosTxtNoDiretorio[i]), i);
                    }
                }
        ...
        private async void btnIncluirNovoElemento_Clicked(object sender, EventArgs e)
        {
            ...
            await Navigation.PushAsync(new Pages.PaginaCadastroNovoPRU());
        }
        ...
        private async void btnEditarElemento_Clicked(object sender, EventArgs e)
        {
            ...
            await Navigation.PushAsync(new Pages.PaginaCadastroEditarPRU());
        }
        ...
        private async void listReceberDadosExterno_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            var _AtendimentoNorma = e.Item as UserModel;
            var _SinalizacaoVertical = e.Item as UserModel;
            var _Auditoria = e.Item as UserModel;
            var _ID = e.Item as UserModel;
            var _TipoFaixa = e.Item as UserModel;
            ...
            ClsEditarElemento.AtendimentoNorma = _AtendimentoNorma.atendimentoNorma;
            ClsEditarElemento.SinalizaçãoVertical = _SinalizacaoVertical.sinalizacaoVertical;
            ClsEditarElemento.Auditoria = _Auditoria.auditoria;
            ClsEditarElemento.ID = _ID.id;

            ClsEditarElemento.TipoFaixa = _TipoFaixa.tipoFaixa;

            var page = new PopUpPRU();
                ...
                switch (ordenar)
                {
                    case "STATUS":
                        ...
                        else
                        {
                            ...
                            listReceberDadosExterno.ItemsSource = SelecionarTodos.ObterRegistroOrdenado(totalDeArquivosTxtNoDiretorio, "STATUS", "PRU");
                            OnPropertyChanged();
                    ...
                    case "KM":
                        ...
                        else
                        {
                            ...
                            listReceberDadosExterno.ItemsSource = null;
                            listReceberDadosExterno.ItemsSource = SelecionarTodos.ObterRegistroOrdenado(totalDeArquivosTxtNoDiretorio, "KM", "PRU");
                            OnPropertyChanged();
                            listReceberDadosExterno.EndRefresh();
                        }
                        break;
