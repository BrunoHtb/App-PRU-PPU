...
namespace rodovias.Pages
{
    ...
    public partial class PopUpPRU : Rg.Plugins.Popup.Pages.PopupPage
    {
        string filePath = "/storage/emulated/0/Android/data/com.esteio.rodoviasPRUePPU/files/" + "Pictures/PRU";
